...
if __name__ == '__main__':
    ...
    #ここはテスト用のディレクトリを作る.
    validation_A_dir_default = './data/test_ja/'
    output_A_dir_default = './converted_sound/test_ja/'

    validation_B_dir_default = './data/test_obama/'
    output_B_dir_default = './converted_sound/test_obama/'
